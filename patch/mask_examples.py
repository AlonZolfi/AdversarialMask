...
img_t = transforms.ToTensor()(Image.open('../datasets/sample1/1/IMG_20211006_153740.jpg')).unsqueeze(0).to(device)
person_id = '6'
...
for mask_path, is_3d, save_name in [('final_patch.png', False, 'adv'),
    ...
    applied = utils.apply_mask(location_extractor, fxz_projector, img_t, mask_t[:, :3], mask_t[:, 3], is_3d=is_3d)
